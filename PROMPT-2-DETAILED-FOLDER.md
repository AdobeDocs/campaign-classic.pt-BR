...
---
# PROMPT 2: analisar a pasta Détaillée d&#39;un
...
Tentar com:
- `/help/delivery/using/` (111 arquivos)
- `/help/workflow/using/` (121 arquivos)
...
O relatório será ~30-40 páginas de Markdown detalhado com:
- Estatísticas do resumo
- Tabela completa com todos os arquivos
- Até 3 correspondências v8 por arquivo
- Porcentagens de correspondência
- Recapitulações detalhadas de arquivos
- Plano de reorganização
- Itens de ação

Perfeito para execução! ✅
