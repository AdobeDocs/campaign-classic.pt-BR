...
A seção Configuração do aplicativo móvel foi atualizada para conexão baseada em token do iOS com APNs. [Leia mais](../../delivery/using/configuring-the-mobile-application.md#creating-ios-app)
...
Adição de uma nova página sobre como configurar o canal de SMS no Campaign em uma infraestrutura de mid-sourcing. [Leia mais](../../delivery/using/sms-set-up-mid.md)

## 2023

### Dezembro de 2023 {#dec-2023}
...
### Março de 2023 {#mar-2023}

Atualização da seção Notas de versão com as melhorias e correções da versão 7.3.3. [Leia mais](latest-release.md)
...
O novo build do Campaign v7.2.2 está disponível. [Saiba mais](../../rn/using/latest-release.md)
...
A versão 20.2.3 do Campaign foi movida para Disponibilidade Geral (GA).
...
A landing page de práticas recomendadas de capacidade de entrega foi aprimorada para facilitar o acesso às subseções. [Leia mais](../../delivery/using/about-deliverability.md)
...
* [Como configurar e implantar um modelo de entrega](../../delivery/using/about-templates.md)
...
A página “Visão geral do gerenciamento da privacidade” foi atualizada para incluir informações sobre a Lei de Proteção de Dados Pessoais (PDPA) da Tailândia e a Lei Geral de Proteção de Dados (LGPD) do Brasil. [Leia mais](../../platform/using/privacy-and-recommendations.md)
...
A seção Monitoramento da capacidade de entrega foi movida e aprimorada. [Leia mais](../../delivery/using/monitoring-deliverability.md)

A seção Solução de problemas da capacidade de entrega foi movida e aprimorada. [Leia mais](../../delivery/using/deliverability-faq.md)

As diretrizes de capacidade de entrega ao iniciar uma nova seção da plataforma foram aprimoradas. [Leia mais](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/introduction.html?lang=pt-BR)
