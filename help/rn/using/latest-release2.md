...
A partir do Campaign Classic 19.2, um status é associado a cada compilação. Você encontrará abaixo a lista de status, o que eles significam e a imagem associada:

![](assets/green2.png)**Disponibilidade** Geral: versão estável mais recente disponível.

![](assets/blue2.png)**Candidato à** versão: validado pela Adobe, aguardando prova de produção.

![](assets/orange2.png)**** Não está mais disponível: versão mais recente disponível, atualização necessária.

![](assets/green3.png)**Disponibilidade** Geral: versão estável mais recente disponível.

![](assets/blue3.png)**Candidato à** versão: validado pela Adobe, aguardando prova de produção.

![](assets/orange3.png)**** Não está mais disponível: versão mais recente disponível, atualização necessária.

<table> 
 <tbody> 
  <tr> 
   <td><img src="assets/green.png"/></td>
   <td>Disponibilidade geral</td>
   <td>Compilação estável mais recente disponível.</td>
  </tr> 
   <tr> 
   <td><img src="assets/blue.png"/></td> 
   <td>Release Candidate</td>
   <td>Esta compilação foi validada pela Adobe.  Aguardando prova de produção.</td>
  </tr> 
  <tr> 
   <td><img src="assets/orange.png"/></td> 
   <td>Não está mais disponível</td>
   <td>Esta compilação não apresenta nenhum problema importante, mas uma versão mais recente está disponível com correções de erros adicionais. É necessário atualizar.</td>
  </tr> 
 </tbody> 
</table>
...
<tr>
  <td>
    ...
    <div>
    <img src="assets/green3.png"/><strong>Disponibilidade geral</strong>
    </div>
    <p>
    <em>Compilação estável mais recente disponível.</em>
    <p>
  </td>
  <td>
    ...
    <p>
    <em>Esta compilação foi validada pela Adobe. Aguardando prova de produção.</em>
    <p>
  </td>
   <td>
    <img src="assets/update.png" />
    <div>
    <img src="assets/orange3.png"/><strong>Não está mais disponível</strong>
    </div>
    <p>
    <em>Esta compilação não apresenta nenhum problema importante, mas uma versão mais recente está disponível com correções de erros adicionais. É necessário atualizar.</em>
    <p>
  </td>
</tr>
</table>
...
| Recursos adicionais: |  |
|--- |--- |
| [Atualização para a versão mais recente](https://helpx.adobe.com/campaign/kb/acc-build-upgrade.html) | [Notas de versão do Painel de controle](https://docs.adobe.com/content/help/en/control-panel/using/release-notes.html) |
| [Atualizações mais recentes da documentação](../../rn/using/documentation-updates.md) | [Notas de versão anteriores](../../rn/using/release--19-1.md) |
| [Recursos descontinuados e removidos](https://helpx.adobe.com/campaign/kb/deprecated-and-removed-features.html) |  |

## ![](assets/blue2.png) Versão 19.2 - Build 9080 {#release-19-2-build-9080}
...
<table> 
 <thead> 
  <tr> 
   <th> Monitoramento ao vivo do fluxo de trabalho<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
...
<table> 
 <thead> 
  <tr> 
   <th> Conteúdo interativo com AMP<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
...
<table> 
 <thead> 
  <tr> 
   <th> Sistema de Mensagens Seguras de SMS (TLS)<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
