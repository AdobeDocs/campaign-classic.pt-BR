...
#### Melhorias de segurança {#security-7-4-4-9401}
...
[!BADGE Obsoleto]{type=Positive url="https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/rn-overview.html?lang=pt-BR#rn-statuses" tooltip="Obsoleto"}
...
Por padrão, webForm.jsp agora ignora os parâmetros `ctx` fornecidos pelo cliente. Isso é controlado pelo parâmetro `disableCtxInWebForm`, que é definido como “true” por padrão.

Se suas solicitações do webForm atualmente passam um parâmetro `ctx`, você pode reativar temporariamente esse comportamento adicionando o seguinte ao <web> elemento de configuração-<instance>do arquivo .xml. Planejar a eliminação progressiva deste uso.
...
_9 de junho de 2026_

Esta build inclui correções de segurança.
...
>[!NOTE]
>
> As correções listadas abaixo foram gradativamente implementadas em builds 7.4.3 sucessivas. Navegue até o [menu](../../platform/using/launching-adobe-campaign.md#getting-your-campaign-version) **[!UICONTROL Help > About...]** para verificar se você tem a build 9394@28aaec9 mais recente. Entre em contato com seu representante da Adobe para obter mais informações.
...
* Correção de um problema em que o Console do cliente podia falhar ao abrir determinados fluxos de trabalho que faziam referência a um esquema de direcionamento upstream ausente. (NEO-28727)
