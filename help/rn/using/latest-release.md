...
>[!CAUTION]
>Campanha **[!UICONTROL Help > About...]** permite que você verifique a [versão e número de compilação](../../platform/using/launching-adobe-campaign.md#getting-your-campaign-version). No entanto, observe que para todas as builds entre 9277 e 9343 listadas nesta página, o número da versão mostra 7.0 em vez de 7.1.
