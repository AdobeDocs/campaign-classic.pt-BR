...
Saiba mais sobre essa migração no [esta página](ac-ims.md).
...
Essa alteração é aplicável a partir do Campaign Classic v7.4.1 (e o mais recente [Versões compatíveis com a migração IMS](ac-ims.md#ims-versions)) e é **obrigatório** para migrar para o Adobe Campaign v8.
...
1. O Adobe atualiza seus ambientes para o Campaign v7.4.1 (ou um [Versão compatível com migração IMS](ac-ims.md#ims-versions)).
...
1. Atualize seus ambientes para o Campaign v7.4.1 (ou um [Versão compatível com migração IMS](#ims-versions)).
1. Após a atualização, ainda será possível criar novos usuários com ambos os métodos, como usuário nativo ou com IMS.
...
O Adobe recomenda criar somente usuários do IMS após atualizar para o Campaign Classic v7.4.1 (ou um [Versão compatível com migração IMS](#ims-versions)).
