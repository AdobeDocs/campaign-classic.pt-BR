...
Como cliente local, você também deve verificar se uma Campanha **[!UICONTROL Product profile]** O está disponível para sua organização. Para fazer isso, siga as etapas abaixo:
