...
>
>Observe que sua instância deve ser atualizada com a variável [build GA mais recente](../../rn/using/rn-overview.md). Saiba como verificar sua versão [nesta seção](../../platform/using/launching-adobe-campaign.md#getting-your-campaign-version).
