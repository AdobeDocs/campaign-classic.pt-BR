...
product: campaign
title: Monitorando a execução de trabalhos
description: Saiba como monitorar a execução de tarefas de importação e exportação.
audience: platform
...
# Monitorando a execução de trabalhos {#monitoring-job-execution}

É possível rastrear a execução de tarefas de importação e exportação diretamente da lista de trabalhos de importação/exportação.
...
Na guia **[!UICONTROL General]**, o campo **[!UICONTROL Status]** indica o status atual de uma tarefa.
