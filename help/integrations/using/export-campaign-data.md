...
>[!NOTE]
>
>Observe que é recomendável exportar os dados gerados pelo Campaign (por exemplo: envios, aberturas, cliques etc.) apenas para a Adobe Experience Platform. Os dados assimilados de uma fonte de terceiros (como seu CRM) devem ser importados diretamente para a Adobe Experience Platform.
