...
A lista padrão de URLs que podem ser chamadas por códigos JavaScript (fluxos de trabalho etc.) pelas instâncias do Campaign Classic é limitada. Esses são os URLs que permitem que as instâncias funcionem corretamente.
