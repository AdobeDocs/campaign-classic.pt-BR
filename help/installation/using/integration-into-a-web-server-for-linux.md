...
1. Desative os módulos carregados por padrão usando o seguinte comando:
   ...
   Verifique se os módulos **alias**, **authz_host** e **mime** ainda estão habilitados. Para fazer isso, use o seguinte comando:
...
1. No arquivo `httpd.conf`, ative os seguintes módulos do Apache:
...
1. Para **RHEL7**:
   ...
   Adicionar o arquivo `/etc/systemd/system/httpd.service` com o seguinte conteúdo:
...
Você também pode solicitar a URL `https://myserver.adobe.com/r/test` de um navegador da Web.
