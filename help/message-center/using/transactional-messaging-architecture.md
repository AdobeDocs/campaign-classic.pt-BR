...
Em seguida, no **[!UICONTROL Explorer]**, em **[!UICONTROL Platform]** > **[!UICONTROL External account]**, é necessário configurar contas externas diferentes em ambas as instâncias:

1. Crie uma conta externa **[!UICONTROL External database]** na sua instância de **execução** com a seguinte configuração:
   ...
   * **[!UICONTROL A caixa habilitada deverá estar marcada.]**
   ...
   * **[!UICONTROL Account]**: digite a conta do seu banco de dados.
   ...
   * A opção **[!UICONTROL Target of an HTTP relay to remote database&#39;s account]** deve estar marcada.
...
1. Crie uma conta **[!UICONTROL External Database]** na sua instância de **marketing** com a seguinte configuração:
   ...
   * **[!UICONTROL Data Source]** : digite a seguinte sintaxe **[!UICONTROL nms:extAccount:ID da sua conta do banco de dados externo na instância de execução]**.
...
1. Crie uma conta externa **[!UICONTROL Execution instance]** em sua instância de **marketing** usando a seguinte configuração para criar o workflow de sincronização de dados:
   ...
   * **[!UICONTROL Account]**: digite a conta usada para acessar a instância de execução.
   * **[!UICONTROL Password]**: digite a senha da conta usada para acessar a instância de execução.
   Da categoria **[!UICONTROL Account connection method]**:
