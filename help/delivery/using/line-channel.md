...
>[!NOTE]
>
>Você deve verificar se os workflows **[!UICONTROL LINE access token update (updateLineAccessToken)]** e **[!UICONTROL Delete blocked LINE users (deleteBlockedLineUsers)]** foram iniciados. No Explorer, clique em **[!UICONTROL Administration > Production > Technical workflows > LINE workflows]** para verificar o status dos workflows.
...
1. Na janela exibida, selecione o template do **[!UICONTROL LINE V2 delivery]** delivery.
