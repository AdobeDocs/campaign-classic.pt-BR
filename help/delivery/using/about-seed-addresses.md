...
Além disso, os seed addresses permitem **visualizar e testar a personalização e renderização dos deliveries** antes de serem enviados, ao enviar provas (consulte [Usar seed addresses como prova](../../delivery/using/steps-defining-the-target-population.md#using-seed-addresses-as-proof).
...
* Substituição aleatória de campos por dados obtidos de perfis de recipients: isso permite inserir somente o endereço de email, por exemplo, na seção seed address e permite que o Campaign preencha automaticamente os outros campos no formulário do perfil (consulte [Caso de uso: configure a substituição de campo (a1/>).](../../delivery/using/use-case--configuring-the-field-substitution.md)
...
>
>Um exemplo de como estender a tabela de seed addresses é apresentado nesta seção: [Caso de uso: selecione seed addresses em critérios](../../delivery/using/use-case--selecting-seed-addresses-on-criteria.md)
