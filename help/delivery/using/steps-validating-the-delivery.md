...
1. **Analisar o delivery**: esta etapa permite preparar as mensagens para a entrega. Consulte [Análise do delivery](#analyzing-the-delivery).
   ...
   The rules applied during analysis are presented in [this section](#validation-process-with-typologies). Os modos de validação disponíveis estão detalhados na seção[Alteração do modo de aprovação](#changing-the-approval-mode).
