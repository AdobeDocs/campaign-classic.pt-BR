...
1. Instale o **[!UICONTROL AMP support]** pacote. Consulte [Instalação de pacotes incorporados do Campaign](../../installation/using/installing-campaign-standard-packages.md).
