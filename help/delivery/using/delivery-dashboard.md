...
>
>Esta página documenta **personalizações específicas do Campaign Classic v7** para implantações híbridas e locais.

O monitoramento de deliveries é essencial para garantir que suas campanhas sejam eficientes e atinjam os clientes.

Para obter informações abrangentes sobre como acessar a lista de entrega, usar as guias do painel de entrega e monitorar suas entregas, consulte a [documentação do Campaign v8 Monitorar entregas na interface do Campaign](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/monitor/delivery-dashboard){target="_blank"}.
...
* [Configuração de email de devolução](understanding-delivery-failures.md) (v7 híbrido/no local)
