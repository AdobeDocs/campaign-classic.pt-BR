...
* **Entrega recorrente**: permite configurar uma ocorrência do modelo da entrega em uma campanha. Consulte [Entrega recorrente](recurring-delivery.md).
...
* **Aprovação local**: permite realizar aprovações e notificações de direcionamento em um contexto de marketing distribuído (módulo opcional). Consulte [Aprovação local](local-approval.md).
...
* **Gerenciamento de conteúdo**: permite criar ou personalizar o conteúdo. Consulte a seção [Gerenciamento de conteúdo](content-management.md).
