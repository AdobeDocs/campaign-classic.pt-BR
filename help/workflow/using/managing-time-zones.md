...
Para obter mais informações sobre a configuração de fusos horários no Adobe Campaign, consulte [Campaign Classic v7 Installation Guide](../../installation/using/time-zone-management.md).
