...
Os workflows detalhados são instalados com o módulo **Marketing
				Distribuído** por padrão. Para obter mais informações sobre esse módulo, consulte esta[seção](../../campaign/using/about-distributed-marketing.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">Processos</span> de marketing distribuídos <br /> </td> 
