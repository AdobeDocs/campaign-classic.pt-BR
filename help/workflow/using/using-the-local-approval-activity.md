...
1. Insira o **[!UICONTROL rótulo]** e o **[!UICONTROL contexto de distribuição]**. Neste exemplo, selecionamos o schema de direcionamento **[!UICONTROL Recipient]** e o campo **[!UICONTROL Email domain]** como um campo de distribuição. A lista de recipients será dividida por domínio.
...
1. No campo **[!UICONTROL Approval storage]**, insira o schema de armazenamento das aprovações que correspondem ao schema de definição do target em uso. Aqui, usaremos o schema de armazenamento padrão: **[!UICONTROL Local approval of recipients]**.
1. Em seguida, clique no link **[!UICONTROL Advanced parameters]**.
...
Se não quiser limitar o público da consulta, não é necessário usar as atividades **[!UICONTROL Query]**, **[!UICONTROL Intersection]** e **[!UICONTROL Split]**. Nesse caso, complete o template de distribuição de dados na primeira atividade **[!UICONTROL Local approval]**.
...
1. Na seção **[!UICONTROL Action to execute]**, escolha **[!UICONTROL Delivery feedback report]**.
1. Na seção **[!UICONTROL Delivery]**, escolha **[!UICONTROL Specified in the transition]**.
