...
O workflow detalhado abaixo é instalado com o módulo **Motor de oferta
				(Interação)** por padrão. Para obter mais informações sobre esse módulo, consulte esta[seção](../../interaction/using/interaction-and-offer-management.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">Cálculo agregado completo (cubo propositionrcp)</span><br /> </td> 
   ...
   <tr> 
   <td> <span class="uicontrol">Cálculo</span> de agregação total do MessageCenter <br /> </td> 
