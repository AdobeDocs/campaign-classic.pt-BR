...
The workflows detailed below are installed with the **Offer engine (Interaction)** module by default. Para obter mais informações sobre esse módulo, consulte esta[seção](../../interaction/using/interaction-and-offer-management.md).
