...
1. Na janela **[!UICONTROL Data do extract]**, selecione **[!UICONTROL Last name]**, **[!UICONTROL First name]** e **[!UICONTROL Gender]**.
...
1. Na janela de pré-visualização, clique em **[!UICONTROL start the preview of the data]**.
