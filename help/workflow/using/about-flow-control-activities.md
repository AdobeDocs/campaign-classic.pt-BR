...
* **Start and End**: permite mostrar os pontos inicial e final de um fluxo de trabalho. Consulte [Início e fim](start-and-end.md).
...
* **Scheduler**: permite definir um agendamento de execução de fluxo de trabalho. Consulte [Scheduler](scheduler.md).
...
* **Subfluxo de trabalho**: permite executar outro fluxo de trabalho. Consulte [Subfluxo de trabalho](sub-workflow.md).
