...
Os workflows detalhados abaixo são instalados com o módulo **Marketing
				Social** por padrão. Para obter mais informações sobre esse módulo, consulte esta[seção](../../social/using/starting-workflows.md).
