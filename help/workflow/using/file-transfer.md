...
1. **Recebimento de arquivos**
   ...
   Para receber arquivos armazenados em um servidor remoto, selecione **[!UICONTROL File download]** no campo **[!UICONTROL Action]**. Você deve especificar sua URL no campo relevante.
...
O link **[!UICONTROL File historization settings...]** fornece acesso às opções detalhadas em [Web download](../../workflow/using/web-download.md) (etapa **[!UICONTROL File historization]**).
