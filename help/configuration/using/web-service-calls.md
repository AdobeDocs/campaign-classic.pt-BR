...
Uma descrição completa do elemento `<method>` de um schema Adobe Campaign está disponível no capítulo &quot;Referências do Schema&quot; em [Método](../../configuration/using/schema/method.md)
