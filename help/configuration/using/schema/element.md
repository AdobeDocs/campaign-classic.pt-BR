---
product: campaign
title: Elementos e atributos do schema - elemento
...
* **aggregate (cadeia de caracteres)**: permite copiar a definição de um `<element>`  por meio de outro schema. Esse atributo recebe uma declaração de schema no formato de &quot;namespace:name&quot;.
...
* **revLink (cadeia de caracteres)**: nome do link oposto. Se o valor for &quot;_NENHUM_&quot;, nenhum link oposto será criado no schema de destino.
