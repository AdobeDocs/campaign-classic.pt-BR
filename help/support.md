...
<table>
    ...
    <td valign="top">
        ...
        <li><a href="delivery/using/delivery-performance-troubleshooting.md">Desempenho da entrega</a></li>
...
Como um Administrador do Campaign, navegue até [esta página](https://experience.adobe.com/#/downloads/content/software-distribution/en/campaign.html) para acessar a Distribuição de software da Experience Cloud.
