...
Neste exemplo, uma exibição **NmcTrackingLogMessages** foi criada e tem um campo **Carimbo** de data e hora chamado **tslog**. Nesse caso, o procedimento de migração falha e a seguinte mensagem de erro é exibida:
