...
Dois outros relatórios sobre pesquisas na Web estão disponíveis na guia **[!UICONTROL Reports]** das pesquisas: **[!UICONTROL General]** e **[!UICONTROL Breakdown of response]**.
...
* Vá para a guia **[!UICONTROL Sub-sets]** e selecione a opção **[!UICONTROL Limit the selected records]** e clique no link **[!UICONTROL Edit...]**.
