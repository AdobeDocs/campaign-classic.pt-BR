...
1. Execute o script de cauterização **nms:freezeInstance.js** no ambiente de destino antes de iniciá-lo.
   ...
   >[!NOTE]
   >
   >No contexto do Adobe Campaign, uma **cauterização** combina ações que permitem interromper a interação de todos os processos com o exterior: logs, rastreamento, entregas, fluxos de trabalho de campanha etc.\
...
Antes de salvar o banco de dados de origem no banco de dados de destino, é necessário exportar a configuração do ambiente de destino (dev). Para fazer isso, exporte o conteúdo destas duas tabelas: **xtkoption** e **nmsextaccount**.
...
>[!NOTE]
>
>Antes de reiniciar o Adobe Campaign no ambiente **dev**, você pode aplicar um procedimento de segurança adicional: iniciar somente o módulo **web**.
>  
