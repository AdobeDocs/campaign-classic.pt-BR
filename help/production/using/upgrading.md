...
>[!NOTE]
>
>Consulte também o guia [de](../../installation/using/general-architecture.md) instalação e a introdução da atualização [da](http://docs.campaign.adobe.com/doc/AC/getting_started/EN/buildUpgrade.html) compilação.
