...
>[!NOTE]
>
>Para o Microsoft SQL Server, você pode usar o plano de manutenção detalhado [nesta página](http://ola.hallengren.com/sql-server-index-and-statistics-maintenance.html).
