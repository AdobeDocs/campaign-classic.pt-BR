...
Ir para **[!UICONTROL Monitoring]** e clique no botão **[!UICONTROL Overview]** para exibir a página de monitoramento do processo do Adobe Campaign.
