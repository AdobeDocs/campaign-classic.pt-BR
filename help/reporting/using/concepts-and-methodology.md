...
No exemplo abaixo, todos os domínios de email que começam com **yahoo** (yahoo.fr, yahoo.com, yahoo.be etc.) ou com **ymail** (ymail.com, ymail.eu etc.) serão agrupados sob o rótulo **YAHOO!**, assim como os endereços com o domínio **rocketmail.com**.
...
* quais medidas exibir: porcentagem, total, número de casas decimais etc. (consulte [Alterar o tipo de medida exibida](#changing-the-type-of-measure-displayed)).
